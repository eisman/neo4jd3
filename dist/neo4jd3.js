...
var Neo4jd3 = /** @class */ (function () {
    ...
    Neo4jd3.prototype.appendGraph = function (container) {
        var _this = this;
        this.svg = container.append('svg')
            ...
            if (_this.svgTranslate) {
                translate[0] += _this.svgTranslate[0];
                translate[1] += _this.svgTranslate[1];
            }
            if (_this.svgScale) {
                scale *= _this.svgScale;
            }
            _this.svg.attr('transform', 'translate(' + translate[0] + ', ' + translate[1] + ') scale(' + scale + ')');
        }))
    ...
    Neo4jd3.prototype.appendImageToNode = function (node) {
        var _this = this;
        return node.append('image')
            .attr('height', function (d) {
            return _this.icon(d) ? '24px' : '30px';
        })
            .attr('x', function (d) {
            return _this.icon(d) ? '5px' : '-15px';
        })
            .attr('xlink:href', function (d) {
            return _this.image(d);
        })
            .attr('y', function (d) {
            return _this.icon(d) ? '5px' : '-16px';
        })
            .attr('width', function (d) {
            return _this.icon(d) ? '24px' : '30px';
        });
    };
    Neo4jd3.prototype.appendInfoPanel = function (container) {
        return container.append('div')
            .attr('class', 'neo4jd3-info');
    };
    Neo4jd3.prototype.appendInfoElement = function (cls, isNode, property, value) {
        var _this = this;
    ...
    Neo4jd3.prototype.appendInfoElementClass = function (cls, node) {
        this.appendInfoElement(cls, true, node);
    };
    Neo4jd3.prototype.appendInfoElementProperty = function (cls, property, value) {
        this.appendInfoElement(cls, false, property, value);
    };
    Neo4jd3.prototype.appendInfoElementRelationship = function (cls, relationship) {
        this.appendInfoElement(cls, false, relationship);
    };
    Neo4jd3.prototype.appendNode = function () {
        var _this = this;
        return this.node.enter()
            ...
            if (_this.options.highlight) {
                for (i = 0; i < _this.options.highlight.length; i++) {
                    highlight = _this.options.highlight[i];
            ...
            .on('click', function (d) {
            d.fx = d.fy = null;
            if (typeof _this.options.onNodeClick === 'function') {
                _this.options.onNodeClick(d);
            }
        })
            .on('dblclick', function (d) {
            _this.stickNode(d);
            if (typeof _this.options.onNodeDoubleClick === 'function') {
                _this.options.onNodeDoubleClick(d);
            }
        })
            ...
            if (typeof _this.options.onNodeMouseEnter === 'function') {
                _this.options.onNodeMouseEnter(d);
            }
        })
            ...
            if (typeof _this.options.onNodeMouseLeave === 'function') {
                _this.options.onNodeMouseLeave(d);
            }
        })
            .call(d3.drag()
    ...
    Neo4jd3.prototype.appendNodeToGraph = function () {
    ...
    Neo4jd3.prototype.appendOutlineToNode = function (node) {
        var _this = this;
        return node.append('circle')
            .attr('class', 'outline')
            .attr('r', this.options.nodeRadius)
            .style('fill', function (d) {
            return _this.options.nodeOutlineFillColor ? _this.options.nodeOutlineFillColor : _this.class2color(d.labels[0]);
        })
    ...
    Neo4jd3.prototype.appendRingToNode = function (node) {
        return node.append('circle')
            .attr('class', 'ring')
    ...
    Neo4jd3.prototype.appendTextToNode = function (node) {
        var _this = this;
        return node.append('text')
            .attr('class', function (d) {
            return 'text' + (_this.icon(d) ? ' icon' : '');
        })
            .attr('fill', '#ffffff')
            .attr('font-size', function (d) {
            return _this.icon(d) ? (_this.options.nodeRadius + 'px') : '10px';
        })
            .attr('pointer-events', 'none')
            .attr('text-anchor', 'middle')
            .attr('y', function (d) {
            return _this.icon(d) ? (Math.round(_this.options.nodeRadius * 0.32) + 'px') : '4px';
        })
            .html(function (d) {
            var _icon = _this.icon(d);
            return _icon ? '&#x' + _icon : d.id;
        });
    };
    Neo4jd3.prototype.appendRandomDataToNode = function (d, maxNodesToGenerate) {
        var data = this.randomD3Data(d, maxNodesToGenerate);
        this.updateWithNeo4jData(data);
    };
    Neo4jd3.prototype.appendRelationship = function () {
        var _this = this;
        return this.relationship.enter()
            .append('g')
            .attr('class', 'relationship')
            .on('dblclick', function (d) {
            if (typeof _this.options.onRelationshipDoubleClick === 'function') {
                _this.options.onRelationshipDoubleClick(d);
            }
        })
            .on('mouseenter', function (d) {
            if (_this.info) {
    ...
    Neo4jd3.prototype.appendOutlineToRelationship = function (r) {
        return r.append('path')
            .attr('class', 'outline')
            .attr('fill', '#a5abb6')
            .attr('stroke', 'none');
    };
    Neo4jd3.prototype.appendOverlayToRelationship = function (r) {
        return r.append('path')
            .attr('class', 'overlay');
    };
    Neo4jd3.prototype.appendTextToRelationship = function (r) {
    ...
    Neo4jd3.prototype.appendRelationshipToGraph = function () {
    ...
    Neo4jd3.prototype.class2color = function (cls) {
    ...
    Neo4jd3.prototype.class2darkenColor = function (cls) {
        return d3.rgb(this.class2color(cls)).darker(1);
    };
    Neo4jd3.prototype.clearInfo = function () {
        this.info.html('');
    };
    Neo4jd3.prototype.color = function () {
        return this.options.colors[this.options.colors.length * Math.random() << 0];
    };
    Neo4jd3.prototype.colors = function () {
        // d3.schemeCategory10,
        // d3.schemeCategory20,
        return [
            '#68bdf6',
    ...
    Neo4jd3.prototype.dragged = function (d) {
        this.stickNode(d);
    };
    Neo4jd3.prototype.dragStarted = function (d) {
        if (!d3.event.active) {
    ...
    Neo4jd3.prototype.extend = function (obj1, obj2) {
        var obj = {};
        this.merge(obj, obj1);
        this.merge(obj, obj2);
        return obj;
    };
    Neo4jd3.prototype.fontAwesomeIcons = function () {
        return {
            'glass': 'f000',
            'music': 'f001',
            'search': 'f002',
    ...
    Neo4jd3.prototype.icon = function (d) {
        var code;
    ...
    Neo4jd3.prototype.image = function (d) {
    ...
    Neo4jd3.prototype.initIconMap = function () {
        var _this = this;
        Object.keys(this.options.iconMap).forEach(function (key) {
            var keys = key.split(','), value = _this.options.iconMap[key];
            keys.forEach(function (key) {
                _this.options.iconMap[key] = value;
            });
        });
    };
    ...
    Neo4jd3.prototype.initSimulation = function () {
        var _this = this;
        return d3.forceSimulation()
            ...
            return _this.options.minCollision;
        }).iterations(2))
    ...
    Neo4jd3.prototype.loadNeo4jData = function () {
        this.nodes = [];
        this.relationships = [];
     ...
     * @deprecated
     */
    Neo4jd3.prototype.loadNeo4jDataFromUrl = function (neo4jDataUrl) {
        // this.nodes = [];
        // this.relationships = [];
    ...
    Neo4jd3.prototype.merge = function (target, source) {
        Object.keys(source).forEach(function (property) {
            target[property] = source[property];
        });
    };
    Neo4jd3.prototype.neo4jDataToD3Data = function (data) {
        var _this = this;
        var graph = {
            nodes: [],
            relationships: []
        ...
        data.results.forEach(function (result) {
            result.data.forEach(function (data) {
                data.graph.nodes.forEach(function (node) {
                    if (!_this.contains(graph.nodes, node.id)) {
    ...
    Neo4jd3.prototype.randomD3Data = function (d, maxNodesToGenerate) {
        var data = {
            nodes: [],
            relationships: []
    ...
    Neo4jd3.prototype.randomLabel = function () {
        var icons = Object.keys(this.options.iconMap);
        return icons[icons.length * Math.random() << 0];
    };
    Neo4jd3.prototype.rotate = function (cx, cy, x, y, angle) {
        var radians = (Math.PI / 180) * angle, cos = Math.cos(radians), sin = Math.sin(radians), nx = (cos * (x - cx)) + (sin * (y - cy)) + cx, ny = (cos * (y - cy)) - (sin * (x - cx)) + cy;
        return { x: nx, y: ny };
    };
    Neo4jd3.prototype.rotatePoint = function (c, p, angle) {
        return this.rotate(c.x, c.y, p.x, p.y, angle);
    };
    Neo4jd3.prototype.rotation = function (source, target) {
        return Math.atan2(target.y - source.y, target.x - source.x) * 180 / Math.PI;
    };
    Neo4jd3.prototype.size = function () {
        return {
            nodes: this.nodes.length,
            relationships: this.relationships.length
        };
    };
    Neo4jd3.prototype.stickNode = function (d) {
        d.fx = d3.event.x;
        d.fy = d3.event.y;
    };
    Neo4jd3.prototype.tick = function () {
        this.tickNodes();
        this.tickRelationships();
    };
    Neo4jd3.prototype.tickNodes = function () {
        if (this.node) {
    ...
    Neo4jd3.prototype.tickRelationships = function () {
        var _this = this;
        if (this.relationship) {
            this.relationship.attr('transform', function (d) {
                var angle = _this.rotation(d.source, d.target);
    ...
    Neo4jd3.prototype.tickRelationshipsOutlines = function () {
        ...
        this.relationship.each(function () {
            ...
            outline.attr('d', function (d) {
                ...
                }, n = network.unitaryNormalVector(d.source, d.target), rotatedPointA1 = network.rotatePoint(center, {
                    x: (network.options.nodeRadius + 1) * u.x - n.x,
                    y: (network.options.nodeRadius + 1) * u.y - n.y
                }, angle), rotatedPointB1 = network.rotatePoint(center, { x: textMargin.x - n.x, y: textMargin.y - n.y }, angle), rotatedPointC1 = network.rotatePoint(center, { x: textMargin.x, y: textMargin.y }, angle), rotatedPointD1 = network.rotatePoint(center, {
                    x: (network.options.nodeRadius + 1) * u.x,
                    y: (network.options.nodeRadius + 1) * u.y
                }, angle), rotatedPointA2 = network.rotatePoint(center, {
                    x: d.target.x - d.source.x - textMargin.x - n.x,
                    y: d.target.y - d.source.y - textMargin.y - n.y
                }, angle), rotatedPointB2 = network.rotatePoint(center, {
                ...
                }, angle), rotatedPointC2 = network.rotatePoint(center, {
                ...
                }, angle), rotatedPointD2 = network.rotatePoint(center, {
                    x: d.target.x - d.source.x - (network.options.nodeRadius + 1) * u.x,
                    y: d.target.y - d.source.y - (network.options.nodeRadius + 1) * u.y
                }, angle), rotatedPointE2 = network.rotatePoint(center, {
                    x: d.target.x - d.source.x - (network.options.nodeRadius + 1) * u.x + (-n.x - u.x) * network.options.arrowSize,
                    y: d.target.y - d.source.y - (network.options.nodeRadius + 1) * u.y + (-n.y - u.y) * network.options.arrowSize
                }, angle), rotatedPointF2 = network.rotatePoint(center, {
                ...
                }, angle), rotatedPointG2 = network.rotatePoint(center, {
    ...
    Neo4jd3.prototype.tickRelationshipsOverlays = function () {
        var _this = this;
        this.relationshipOverlay.attr('d', function (d) {
            var center = { x: 0, y: 0 }, angle = _this.rotation(d.source, d.target), n1 = _this.unitaryNormalVector(d.source, d.target), n = _this.unitaryNormalVector(d.source, d.target, 50), rotatedPointA = _this.rotatePoint(center, { x: 0 - n.x, y: 0 - n.y }, angle), rotatedPointB = _this.rotatePoint(center, {
                x: d.target.x - d.source.x - n.x,
                y: d.target.y - d.source.y - n.y
            }, angle), rotatedPointC = _this.rotatePoint(center, {
                x: d.target.x - d.source.x + n.x - n1.x,
                y: d.target.y - d.source.y + n.y - n1.y
            }, angle), rotatedPointD = _this.rotatePoint(center, { x: 0 + n.x - n1.x, y: 0 + n.y - n1.y }, angle);
    ...
    Neo4jd3.prototype.tickRelationshipsTexts = function () {
        var _this = this;
        this.relationshipText.attr('transform', function (d) {
            var angle = (_this.rotation(d.source, d.target) + 360) % 360, mirror = angle > 90 && angle < 270, center = { x: 0, y: 0 }, n = _this.unitaryNormalVector(d.source, d.target), nWeight = mirror ? 2 : -3, point = {
                x: (d.target.x - d.source.x) * 0.5 + n.x * nWeight,
                y: (d.target.y - d.source.y) * 0.5 + n.y * nWeight
            }, rotatedPoint = _this.rotatePoint(center, point, angle);
            return 'translate(' + rotatedPoint.x + ', ' + rotatedPoint.y + ') rotate(' + (mirror ? 180 : 0) + ')';
        });
    };
    Neo4jd3.prototype.toString = function (d) {
    ...
    Neo4jd3.prototype.unitaryNormalVector = function (source, target, newLength) {
        if (newLength === void 0) { newLength = null; }
        var center = { x: 0, y: 0 }, vector = this.unitaryVector(source, target, newLength);
        return this.rotatePoint(center, vector, 90);
    };
    Neo4jd3.prototype.unitaryVector = function (source, target, newLength) {
        if (newLength === void 0) { newLength = null; }
    ...
    Neo4jd3.prototype.updateWithD3Data = function (d3Data) {
        this.updateNodesAndRelationships(d3Data.nodes, d3Data.relationships);
    };
    Neo4jd3.prototype.updateWithNeo4jData = function (neo4jData) {
        var d3Data = this.neo4jDataToD3Data(neo4jData);
        this.updateWithD3Data(d3Data);
    };
    Neo4jd3.prototype.updateInfo = function (d) {
        var _this = this;
        this.clearInfo();
        if (d.labels) {
        ...
        Object.keys(d.properties).forEach(function (property) {
            _this.appendInfoElementProperty('property', property, JSON.stringify(d.properties[property]));
        });
    };
    Neo4jd3.prototype.updateNodes = function (n) {
    ...
    Neo4jd3.prototype.updateNodesAndRelationships = function (n, r) {
        this.updateRelationships(r);
        this.updateNodes(n);
        this.simulation.nodes(this.nodes);
        this.simulation.force('link').links(this.relationships);
    };
    Neo4jd3.prototype.updateRelationships = function (r) {
